...
\begin{tabular}{ | p{4,7cm} | p{10,3cm} |}
  ...
  The research for a new Digital Right Management (DRM) infrastructure for electronic books (e-book) is a task of the eReading work-package from the Next Media project. The goal of this thesis is to to propose a protection system that could help limiting copyright infringement while allowing fair use of e-books.\newline
...
The last task produced for the Next Media project was the participation in the reflection group about e-book protection initiated by the Finnish Book Publishers Association. The outcome of this work is the DRM recommendation sent to the Finnish publishers in June 2013. The main result of this publication is that two major Finnish publishers abandoned DRM in favour of the watermark and Social DRM lighter protection system\footnote{\url{https://www.sttinfo.fi/release?releaseId=8700912}}. The DRM recommendation was accompanied by the Web crawler text presented in annex \ref{app:crawl} or as a stand alone text in github\footnote{\url{https://github.com/patrick-ausderau/thesis}}
...
The  need to have copyright for an electronic book (e-book) in order to be respected when it comes to the moral and material interests of an author, is a legitimate one. However, this study shows that none of the technical options to protect e-books from illegal uses are perfect. Trying to impose the rules of the physical world to the electronic one simply does not work. 
...
The Social DRM and watermark combination might be the least problematic technical solution since it does not impose restriction on usage, but offers some level of protection and helps deter from copyright infringement. However, it raises privacy issues and could participate in restricting the freedom of opinion.

For these reasons, for e-books to be DRM-free would be the better option. It might show that the authors trust and respect their readers. Copyright and licenses, such as the Creative Commons, do provide protection and being DRM-free does not prevent anyone from doing business. 

Finally, this thesis proposes that further research to find a working solution in reducing copyright infringement should also be studied at the educational, financial, political and legal levels.

%=================== BIBLIOGRAPHY =================
\begin{flushleft}\begin{singlespacing}
\bibliography{biblio}
\end{singlespacing}\end{flushleft}
