...
The copyright for e-book such as the moral and material interests of the author is legitimate. But the research conducted shows that among the technical options to protect e-book from illegal uses, none is perfect. Trying to impose the rules of the physical world to the electronic one is not suitable. 
...
The Social DRM and watermark combination might be the less problematic technical solution. It can be better accepted by the users, offers some level of protection and help deter on copyright infringement. However, it may be rejected because of privacy concern.
